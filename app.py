...
Be highly accurate - "feeling weird" = uncomfortable/confused, "not good" = sadness/disappointment, etc."""
    ...
    def generate_empathic_response(self, transcript, emotions, conversation_history=None, emotional_context="", empathy_guidance=""):
        ...
        # Create highly empathic system prompt - YOUR ORIGINAL PROMPTING PRESERVED
        system_prompt = f"""You are a empathic friendly companion who's main aim is to talk and understand the user
            Analyze the emotional content of this user message with high accuracy and nuance, and respond very empathically- maintain 
            a friendly conversation and understand what underlying behaviour is causing the user to feel this way.
...
- Your main aim is to identify what behaviour of theirs is causing this action."""
    ...
    def get_empathic_fallback_response(self, transcript, emotion_name, conversation_history=None, emotional_context=""):
        ...
        # General empathic responses (as you requested - no hardcoded emotion-specific responses)
        if is_continuation:
